...
# comment_create도 기능만 하고 view파일이 필요 없으니까 @가 없어도 됩니다!  
...
# destroy_comment도 기능만 하고 view파일이 필요 없으니까 @가 없어도 됩니다!  
# 게다가 Comment.find(params[:id]).destroy 한 줄로 삭제가 가능합니다!

  def comment_edit
    @one_comment = Comment.find(params[:id])
  end  
# 수정하기 위해 댓글의 기존 내용을 보여주니까 뷰파일에 전달해야하고, 변수 앞에 @가 있어야 함!
...
# comment_update는 기능만 하고 view파일이 필요 없으니까 @가 없어도 됩니다!
# edit 뷰파일 필요 없으니까 삭제 삭제!  
end
